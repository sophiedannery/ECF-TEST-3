...
<main>
    ...
    <div class="container">
        <a href="/pages/animaux/animaux_emp.php" class="btn btn-primary">Liste des Animaux - Test 1</a>
        <br>
        <br>
        <a href="/pages/animaux/animaux_emp_test.php" class="btn btn-primary">Liste des Animaux - Test 2</a>
        <br>
        <br>
        <a href="/pages/avis/admin_avis.php" class="btn btn-primary">Valider les avis</a>
        <br>
        <br>
        <a href="/pages/services/services_conf.php" class="btn btn-primary">Modifier les services</a>
        <br>
        <br>
